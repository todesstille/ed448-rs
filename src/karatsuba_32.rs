use crate::constants32::{BigNumber, dword, word, radixMask, nLimbs};
...
pub fn karatsuba_mul(a: &BigNumber, b: &BigNumber) -> BigNumber {
	...
	c[0] = (z0 as word) & radixMask;
	c[8] = (z1 as word) & radixMask;
	...
	c[1] = (z0 as word) & radixMask;
	c[9] = (z1 as word) & radixMask;
	...
	c[2] = (z0 as word) & radixMask;
	c[10] = (z1 as word) & radixMask;
	...
	c[3] = (z0 as word) & radixMask;
	c[11] = (z1 as word) & radixMask;
	...
	c[4] = (z0 as word) & radixMask;
	c[12] = (z1 as word) & radixMask;
	...
	c[5] = (z0 as word) & radixMask;
	c[13] = (z1 as word) & radixMask;
	...
	c[6] = (z0 as word) & radixMask;
	c[14] = (z1 as word) & radixMask;
	...
	c[7] = (z0 as word) & radixMask;
	c[15] = (z1 as word) & radixMask;
	...
	c[8] =(z0 as word) & radixMask;
	c[0] =(z1 as word) & radixMask;
...
mod tests {
    ...
    pub fn test_karatsuba () {
		...
		let (mut y, _) = deserialize([0x74, 0xa8, 0xbc, 0x39, 0x4b, 0x75, 0xd2,
		...
		let (mut res, _) = deserialize([0x11, 0x95, 0x9c, 0x2e, 0x91, 0x78, 0x6f,
