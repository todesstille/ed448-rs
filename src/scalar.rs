...
mod tests {
    ...
    fn test_scalar_decode() {
        ...
        let mut b: &[u8] = &[0xf0, 0xe4, 0x4d, 0xd4, 0x98, 0xf3, 0xad, 0x30, 0x83, 0xe1, 0xf5, 0xfc, 0xc1, 0x44, 0xed, 0x1f, 0xf5, 0xfb, 0x62, 0x5b, 0xa6, 0x21, 0x41, 0xa8, 0xde, 0x2a, 0x90, 0x23, 0x13, 0xb3, 0x1a, 0xd1, 0x41, 0x13, 0x42, 0x94, 0xdb, 0x9b, 0x0d, 0x84, 0xec, 0x43, 0x7a, 0x51, 0x5a, 0x9b, 0x85, 0xbd, 0xa1, 0xb1, 0x5e, 0xac, 0xeb, 0xe4, 0xa3, 0xb2, 0x0];
        let mut exp = [0x7d9d5b0a, 0xe9bc6e73, 0xe16ac2d8, 0xdd13bfdc, 0xfdb68ed4, 0x1fa36b12, 0x29fbe30b, 0xd11ab314, 0x94421341, 0x840d9bdb, 0x517a43ec, 0xbd859b5a, 0xac5eb1a1, 0x32a3e4eb];
        let mut x = decode_long(&b);
        assert_eq!(x, exp);
    }
}